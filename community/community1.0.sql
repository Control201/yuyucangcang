...
INSERT INTO `article` VALUES (10085, '开发日志2.0', 1580265547356934382, '2020-03-28 20:05:47', 1, '<p align=\"left\">优化代码；</p><p align=\"left\">界面优化；</p><p align=\"left\">图片管理--删除无用图片；</p><p align=\"left\">将实现搜索文章功能 ---Lucene；</p><p align=\"left\">将实现每日经验上限30---redis；</p><p align=\"left\">将实现评论+3，发文章+5 获取经验；</p><p align=\"left\">将实现用户选择徽章，扩张相关功能；</p><p align=\"left\">将实现办公室权限，管理社区内容；</p><p align=\"left\">将实现qq或者微博登录，并且绑定账号；</p><p align=\"left\">添加音乐播放器；</p><p align=\"left\">用户挂机锁；</p><p></p><p></p>', 0, 0, 0, 0, 1, 0, '[]', '2020-03-28 20:05:47');
